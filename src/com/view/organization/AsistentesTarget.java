 ...
 * @since 18/09/22
 */
public class AsistentesTarget extends Styles {
    private AsistenteModel asistente;

    /**
     * Creates new form PacienteTarget
     * @param asistenteModel
     */
    public AsistentesTarget(AsistenteModel asistenteModel) {
        initComponents();
        styleMyComponentBaby();
        asistente = asistenteModel;
        
        nombreText.setText(asistenteModel.getNombres() + " " + asistenteModel.getApellidos());
        edadText.setText(String.valueOf(asistenteModel.getEdad()));
        generoText.setText(asistenteModel.getGenero());
        contactoText.setText(asistenteModel.getTelefonoCelular());
        idText.setText(String.valueOf(asistenteModel.getId()));
        
        if (!asistenteModel.getEstadoActividad().equals("activo")) {
            Tools.setImageLabel(estadoIcon, "src/com/assets/circulo-cruzado.png", 50, 50, StateColors.getDanger());
        } else {
            Tools.setImageLabel(estadoIcon, "src/com/assets/activo.png", 50, 50, StateColors.getSuccess());
        }
    ...
    public void mostrarDatos() {
        ApplicationContext.selectedAsistente = asistente;
        ApplicationContext.modificarInformacionAsistente.setData(asistente);
        ApplicationContext.mainInterface.mostrarPanel(ApplicationContext.modificarAsistente);
        ApplicationContext.mainInterface.changeTitle("Modificar paciente");
        
//        ApplicationContext.selectedPacient = paciente;
//        ApplicationContext.generales = new Generales();
//        ApplicationContext.datosGenerales = new GeneralDatos();
//        
//        ApplicationContext.odontologiaDatos = new OdontologiaDatos();
//        ApplicationContext.ortodonciaDatos = new OrtodonciaDatos();
//        ApplicationContext.datosOrtodoncia = new DatosOrtodoncia();
//        ApplicationContext.datosOdontologia = new DatosOdontologia();
//        
//        ApplicationContext.mainInterface.mostrarPanel(ApplicationContext.paciente);
    ...
    public void addTitlesAndSubtitles() {
        ...
        TITLES_AND_SUBTITLES.add(idText);
    }
    ...
    private void initComponents() {
        ...
        estadoIcon = new javax.swing.JLabel();
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel10Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(contactoText, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        ...
        idText.setFont(new java.awt.Font("Microsoft YaHei UI", 0, 12)); // NOI18N
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel11Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(idText, javax.swing.GroupLayout.DEFAULT_SIZE, 63, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        jPanel11Layout.setVerticalGroup(
            ...
            .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel11Layout.createSequentialGroup()
                    .addGap(11, 11, 11)
                    .addComponent(idText, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                    .addGap(11, 11, 11)))
        );
        ...
        estadoIcon.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel5.add(estadoIcon, java.awt.BorderLayout.CENTER);
...
//        ApplicationContext.tratamientosTargets.forEach(target -> target.colorComponent());
...
//        ApplicationContext.mainInterface.mostrarPanel(ApplicationContext.paciente);
    ...
    private javax.swing.JLabel estadoIcon;
