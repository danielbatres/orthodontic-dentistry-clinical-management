 ...
 * @since 18/09/22
 */
public class PacienteTable extends javax.swing.JPanel {
    ...
    public void listPacients(ArrayList<PacienteModel> pacientes) {
        ApplicationContext.pacientesTargets.clear();
        targets.removeAll();
        
        for (PacienteModel pacienteModel : pacientes) {
            ApplicationContext.pacientesTargets.add(new PacientTarget1(pacienteModel));
        }
        
        ApplicationContext.pacientesTargets.forEach(target -> targets.add(target));
    }
