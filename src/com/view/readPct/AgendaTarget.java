 ...
 * @since 19/09/22
 */
public class AgendaTarget extends Styles {
     ...
     * @param consulta
     */
    public AgendaTarget(ConsultaModel consulta) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(fecha, javax.swing.GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(container2, javax.swing.GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(editIcon, javax.swing.GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(facturaContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void editIconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editIconMouseClicked
        ApplicationContext.modificarConsulta.setData(CONSULTA_MODEL);
        ApplicationContext.paciente.mostrarPanel(ApplicationContext.modificarConsulta);
    ...
    private void facturaContainerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_facturaContainerMouseClicked
        if (factura.getText().equals("Facturar")) {
            ApplicationContext.facturaData.setPacientName(ApplicationContext.selectedPacient.getNombres() + " " + ApplicationContext.selectedPacient.getApellidos(), CONSULTA_MODEL.getId());
