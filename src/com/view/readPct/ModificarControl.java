 ...
 */
public class ModificarControl extends Styles {

    /**
     * Creates new form ModificarControl
     */
    public ModificarControl() {
        initComponents();
        styleMyComponentBaby();
        Tools.showPanel(placeContent, ApplicationContext.modificarControlFields, 10, 10);
    ...
    private void saveButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveButtonMouseClicked
        ControlMensualHelper.updateControlMensual(ApplicationContext.modificarControlFields.getData());
        
        int index = 0;
        
        for (ControlMensualModel control : ApplicationContext.controlMensualListado) {
            if (control.getId() == ApplicationContext.selectedControlMensual.getId()) {
                break;
            }
            index++;
        }
        ...
        ApplicationContext.datosControl.setData(ApplicationContext.controlMensualListado.get(index));
        ApplicationContext.selectedControlMensual = ApplicationContext.controlMensualListado.get(index);
