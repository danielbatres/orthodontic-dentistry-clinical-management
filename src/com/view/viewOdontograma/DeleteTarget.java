 ...
 * @since 3/10/22
 */
public class DeleteTarget extends javax.swing.JFrame {
    private DienteOdontogramaModel diente;
    ...
    public void colorBasics() {
        ...
        descripcion.setForeground(ChoosedPalette.getTextColor());
    }
    ...
    private void initComponents() {
        ...
        content.add(descripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 160, 450, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteTarget.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteTarget().setVisible(true);
            }
        });
    }
