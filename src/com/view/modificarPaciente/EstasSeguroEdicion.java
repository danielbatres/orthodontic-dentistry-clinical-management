 ...
 * @since 3/10/22
 */
public class EstasSeguroEdicion extends javax.swing.JFrame {

    /**
     * Creates new form EstasSeguroEdicion
     */
    public EstasSeguroEdicion() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstasSeguroEdicion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EstasSeguroEdicion().setVisible(true);
            }
        });
    }
