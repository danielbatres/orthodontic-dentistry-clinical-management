 ...
 * @since 23/09/22
 */
public class ModifyPacienteInformation extends NewContext {
    ...
    /**
     * Creates new form NewPacienteInformation
     */
    public ModifyPacienteInformation() {
        initComponents();
        styleMyComponentBaby();
    }
    
    public PacienteModel devolverDatos() {
        PacienteModel pacienteLocal = new PacienteModel();
        
        boolean tratamientoOdontologia = false;
        boolean tratamientoOrtodoncia = false;
        
        String selectedItem = tratamientoCombo.getSelectedItem().toString();
        
        switch (selectedItem) {
            case "Odontolog\u00eda":
                tratamientoOdontologia = true;
                break;
            case "Ortodoncia":
                tratamientoOrtodoncia = true;
                break;
            default:
                tratamientoOdontologia = true;
                tratamientoOrtodoncia = true;
        ...
        try {
            pacienteLocal.setId(ApplicationContext.selectedPacient.getId());
            pacienteLocal.setTratamientoOdontologico(tratamientoOdontologia);
            pacienteLocal.setTratamientoOrtodontico(tratamientoOrtodoncia);
            pacienteLocal.setParentesco(emptyMessage(textField7.getText()));
            pacienteLocal.setResponsables(emptyMessage(textField8.getText()));
            pacienteLocal.setEstadoDeActividad(actividadCombo.getSelectedItem().toString().toLowerCase());
            pacienteLocal.setEdad(Integer.parseInt(textField6.getText()));
            pacienteLocal.setDiaNacimiento(Integer.parseInt(textField2.getText()));
            pacienteLocal.setMesNacimiento(Integer.parseInt(textField3.getText()));
            pacienteLocal.setAnnioNacimiento(Integer.parseInt(textField4.getText()));
            pacienteLocal.setNombres(emptyMessage(textField1.getText()));
            pacienteLocal.setApellidos(emptyMessage(textField5.getText()));
            pacienteLocal.setGenero(generoCombo.getSelectedItem().toString());
            pacienteLocal.setTelefonoCelular(emptyMessage(textField9.getText()));
            pacienteLocal.setTelefonoCasa(emptyMessage(textField10.getText()));
            pacienteLocal.setDireccion(emptyMessage(textField11.getText()));
            pacienteLocal.setDepartamento(comboDepartamento.getSelectedItem().toString());
            pacienteLocal.setMunicipio(textField12.getText());
            pacienteLocal.setDiaCreacion(LocalDateTime.now().getDayOfMonth());
            pacienteLocal.setMesCreacion(LocalDateTime.now().getMonthValue());
            pacienteLocal.setAnnioCreacion(LocalDateTime.now().getYear());
            pacienteLocal.setHoraCreacion(String.valueOf(LocalDateTime.now().getHour()) + ":" + String.valueOf(LocalDateTime.now().getMinute()) + " " + NewContext.localTime.format(dateTimeFormatter));
            pacienteLocal.setDiaModificacion(LocalDateTime.now().getDayOfMonth());
            pacienteLocal.setMesModificacion(LocalDateTime.now().getMonthValue());
            pacienteLocal.setAnnioModificacion(LocalDateTime.now().getYear());
            pacienteLocal.setHoraModificacion(String.valueOf(LocalDateTime.now().getHour()) + ":" + String.valueOf(LocalDateTime.now().getMinute()) + " " + NewContext.localTime.format(dateTimeFormatter));
    ...
    public void setData(PacienteModel paciente) {
        textField1.setText(paciente.getNombres());
        textField5.setText(paciente.getApellidos());
        textField2.setText(String.valueOf(paciente.getDiaNacimiento()));
        textField3.setText(String.valueOf(paciente.getMesNacimiento()));
        textField4.setText(String.valueOf(paciente.getAnnioNacimiento()));
        textField6.setText(String.valueOf(paciente.getEdad()));
        textField7.setText(paciente.getParentesco());
        textField8.setText(paciente.getResponsables());
        ...
        if (paciente.isTratamientoOdontologico() && paciente.isTratamientoOrtodontico()) {
            tratamientoCombo.setSelectedIndex(3);
            ApplicationContext.modificarOdontologiaPaciente.setData(paciente);
            ApplicationContext.modificarOrtodonciaPaciente.setData(paciente);
        } else {
        ...
        textField9.setText(paciente.getTelefonoCelular());
        textField10.setText(paciente.getTelefonoCasa());
        textField12.setText(paciente.getMunicipio());
        textField11.setText(paciente.getDireccion());
        
        switch (paciente.getDepartamento()) {
            case "Sonsonate":
        ...
        switch (paciente.getEstadoDeActividad()) {
            case "activo":
    ...
    private void addItemsComboBox() {
        ...
        tratamientoCombo.addItem("Ambos");
        actividadCombo.addItem("Activo");
        actividadCombo.addItem("Inactivo");
    }
    ...
    public void validarCombo() {
        ...
        validacionCombo(tratamientoCombo, advertenciaTratamiento, "Elegir tratamiento");
    }
    ...
    private void addItemsDepartamento() {
        ...
        comboDepartamento.addItem("Caba\u00f1as");
    ...
    private void initComponents() {
        ...
        actividadCombo = new javax.swing.JComboBox<>();
        ...
        jPanel16Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tratamientoCombo, 0, 228, Short.MAX_VALUE)
                    .addGroup(jPanel16Layout.createSequentialGroup()
                        .addComponent(title8)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(advertenciaTratamiento, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        actividadCombo.setBorder(null);
        actividadCombo.setFocusable(false);
        actividadCombo.setOpaque(false);
        actividadCombo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                actividadComboActionPerformed(evt);
            }
        });
        ...
        jPanel75Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel75Layout.createSequentialGroup()
                ...
                .addGroup(jPanel75Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(actividadCombo, 0, 228, Short.MAX_VALUE)
                    .addGroup(jPanel75Layout.createSequentialGroup()
        ...
        jPanel75Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel75Layout.createSequentialGroup()
                .addGap(12, 12, 12)
                .addComponent(title16, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(actividadCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(7, 7, 7))
        );

        jPanel27.add(jPanel75);
    ...
    private void tratamientoComboItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_tratamientoComboItemStateChanged
        ...
        if (selectedItem.equals("Odontolog\u00eda")) {
            NewContext.isTratamientoOdontologico = true;
            NewContext.isTratamientoOrtodontico = false;
        } else if (selectedItem.equals("Ortodoncia")) {
            NewContext.isTratamientoOrtodontico = true;
            NewContext.isTratamientoOdontologico = false;
        } else if (selectedItem.equals("Ambos")) {
            NewContext.isTratamientoOrtodontico = true;
            NewContext.isTratamientoOdontologico = true;
        } else {
            NewContext.isTratamientoOrtodontico = false;
    ...
    private void actividadComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actividadComboActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_actividadComboActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox<String> actividadCombo;
