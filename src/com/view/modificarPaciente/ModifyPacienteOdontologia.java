 ...
 * @since 23/09/22
 */
public class ModifyPacienteOdontologia extends NewContext {
    
    /**
     * Creates new form ModifyPacienteOdontologia
     */
    public ModifyPacienteOdontologia() {
        initComponents();
    ...
    public void setData(PacienteModel paciente) {
        textField1.setText(paciente.getFichaOdontologia().getHO());
        textField2.setText(paciente.getFichaOdontologia().getHM());
        textField3.setText(paciente.getFichaOdontologia().getTipoDeAnestesico());
        textField4.setText(paciente.getFichaOdontologia().getMedicamentos());
        textField5.setText(paciente.getFichaOdontologia().getObservaciones());
        textField6.setText(paciente.getFichaOdontologia().getProtesis());
        textField7.setText(paciente.getFichaOdontologia().getAnotacionesProtesis());
    }
