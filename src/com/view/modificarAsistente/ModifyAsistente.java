 ...
 */
public class ModifyAsistente extends Styles {
    
    /**
     * Creates new form ModifyAsistente
     */
    public ModifyAsistente() {
        initComponents();
        styleMyComponentBaby();
        Tools.showPanel(dataContent, ApplicationContext.modificarInformacionAsistente, 10, 10);
    }
    ...
    private void saveButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveButtonMouseClicked
        NewContext.validarTodosLosCampos(ApplicationContext.modificarInformacionAsistente.camposTexto, ApplicationContext.modificarInformacionAsistente.advertenciasTexto, ApplicationContext.modificarInformacionAsistente.containersTexto);
        ApplicationContext.modificarInformacionAsistente.validarCombo();
        ApplicationContext.modificarInformacionAsistente.validarEdad();
        ApplicationContext.modificarInformacionAsistente.validarFechaNacimiento();
        ApplicationContext.modificarInformacionAsistente.verifyEmpty();
        ...
        if (NewContext.countedErrors == 0) {
            if (NewContext.emptyCounter != 0) {
                ...
                AsistenteHelper.updateAsistenteData(ApplicationContext.modificarInformacionAsistente.devolverDatos());
            }
        }
