 ...
 * @since 23/09/22
 */
public class NewPacienteInformation extends NewContext {
    ...
    public PacienteModel devolverDatos() {
        ...
        paciente.setTratamientoOdontologico(tratamientoOdontologia);
        paciente.setTratamientoOrtodontico(tratamientoOrtodoncia);
        paciente.setParentesco(emptyMessage(textField7.getText()));
        paciente.setResponsables(emptyMessage(textField8.getText()));
        paciente.setEstadoDeActividad("activo");
        paciente.setEdad(Integer.parseInt(textField6.getText()));
        paciente.setDiaNacimiento(Integer.parseInt(textField2.getText()));
        paciente.setMesNacimiento(Integer.parseInt(textField3.getText()));
        paciente.setAnnioNacimiento(Integer.parseInt(textField4.getText()));
        paciente.setNombres(emptyMessage(textField1.getText()));
        paciente.setApellidos(emptyMessage(textField5.getText()));
        paciente.setGenero(generoCombo.getSelectedItem().toString());
        paciente.setTelefonoCelular(emptyMessage(textField9.getText()));
        paciente.setTelefonoCasa(emptyMessage(textField10.getText()));
        paciente.setDireccion(emptyMessage(textField11.getText()));
        paciente.setDepartamento(comboDepartamento.getSelectedItem().toString());
        paciente.setMunicipio(emptyMessage(textField12.getText()));
        paciente.setDiaCreacion(LocalDateTime.now().getDayOfMonth());
        paciente.setMesCreacion(LocalDateTime.now().getMonthValue());
        paciente.setAnnioCreacion(LocalDateTime.now().getYear());
        paciente.setHoraCreacion(String.valueOf(LocalDateTime.now().getHour()) + ":" + String.valueOf(LocalDateTime.now().getMinute()) + " " + NewContext.localTime.format(dateTimeFormatter));
        paciente.setDiaModificacion(LocalDateTime.now().getDayOfMonth());
        paciente.setMesModificacion(LocalDateTime.now().getMonthValue());
        paciente.setAnnioModificacion(LocalDateTime.now().getYear());
        paciente.setHoraModificacion(String.valueOf(LocalDateTime.now().getHour()) + ":" + String.valueOf(LocalDateTime.now().getMinute()) + " " + NewContext.localTime.format(dateTimeFormatter));
