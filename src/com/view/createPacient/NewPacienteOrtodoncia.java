 ...
 */
public class NewPacienteOrtodoncia extends NewContext {
        
    /**
     * Creates new form NewPacienteOrtodoncia
     */
    public NewPacienteOrtodoncia() {
        initComponents();
    ...
    public FichaOrtodonciaModel devolverFicha() {
        ...
        if (comboExtracciones.getSelectedItem().toString().equals("SI")) {
            fichaOrtodoncia.setExtracciones(true);
        } else {
            fichaOrtodoncia.setExtracciones(false);
        }
